...
const OrderDetails = props => {
  ...
  const CancleOrder = async () => {
    try {
      ...
      const res = await getChangeStatus(valuesCancle);
      ...
      {loading ? (
        ...
        <>
          <KeyboardAvoidScrollview
            ...
            {complete?.order_details?.delivery_status === 'cancelled' ? (
              <>
                <View
                  style={{
                    ...styles.innerContainer,
                    margintop: complete?.order_details?.delivery_status
                      ? mvs(0)
                      : mvs(20),
                    backgroundColor: colors.downColor,
                  }}>
                  <Row style={{marginTop: mvs(0)}}>
                      ...
                      <Row>
                        ...
                        <View
                          style={[
                            ...
                            {
                              backgroundColor:
                                complete?.order_details?.payment_status ===
                                'paid'
                                  ? colors.green
                                  : colors.red,
                            },
                    ...
                    <View style={{width: '45%'}}>
                      ...
                      <Row style={{justifyContent: 'flex-start'}}>
                        ...
                        <Regular
                          ...
                          fontSize={mvs(12)}
                          label={
                            complete?.shipping_adress_developer?.postal_code
                          }
                        />
                      </Row>
                    </View>
